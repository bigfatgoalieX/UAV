...
MAIN_FOLDER = "dqn/" + datetime.now().strftime("%Y%m%d-%H%M%S")
...
class DQNAgent:
    ...
    def update(self, s, a, r, s_, d):
        ...
        with torch.no_grad():
            ...
            q_s_a = self._qnet(s_).gather(1, indices.reshape(-1, 1)).reshape(-1)
...
class DQNTrainer:
    ...
    def __init__(self, env):
        ...
        self._agent = DQNAgent(self._obs_dim, self._act_cnt, self._sw)
