...
MAIN_FOLDER = "ddpg_centralized/" + datetime.now().strftime("%Y%m%d-%H%M%S")
...
class DDPGTrainer:
    ...
    def __init__(self, env, obs_dim, action_dim):
        ...
        self._agent = DDPGAgent(self._obs_dim, self._action_dim, self._sw)
...
if __name__ == "__main__":
    ...
    env = SampleEnv()
    trainer = DDPGTrainer(env=env, obs_dim=6, action_dim=2)
